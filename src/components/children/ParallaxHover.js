...
//
// const config = {
//   scale: 1, // How large to scale the item: 1.00 -> 1.10~
//   rotation: 0.2, // Rotation modifier: 0.1 (more) -> 0.5 (less)
//   alpha: 0.1, // Alpha channel modifer: 1.01 -> 1.1~
...
//
//     return (
//       <div style={{ transformStyle: 'preserve-2d'}}>
